...
```bash
abinit-lsp-tool check path/to/input --format json
abinit-lsp-tool context path/to/input --format json
abinit-lsp-tool complete path/to/input --format json
abinit-lsp-tool hover path/to/input --format json
abinit-lsp-tool symbols path/to/input --format json
abinit-lsp-tool fix path/to/input --format json
```
